...
» تحكم 「ضبط مستوئ الصوت」
» حدث 「لتحديث البوت و قائمة المشرفين」
» انضم 「لاستدعاء الحساب المساعد」
» ادر 「لطرد الحساب المساعد」
⚡ قناة البوت @{UPDATES_CHANNEL}""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 رجوع", callback_data="cbcmds")]]
        ),
...
» محو 「لحذف جميع الملفات 」
» تنظيف 「حذف جميع الملفات المحمله」
» ريستارت 「اعاده تشغيل البوت」
» خروج「خروج الحساب المساعد من جميع المجموعات」
